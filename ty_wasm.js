...
const CompletionFinalization =
  typeof FinalizationRegistry === "undefined"
    ...
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_completion_free(ptr >>> 0, 1),
      );
...
export class Completion {
   ...
   */
  set kind(arg0) {
    wasm.__wbg_set_completion_kind(
      this.__wbg_ptr,
      isLikeNone(arg0) ? 25 : arg0,
    );
  }
  /**
...
const DiagnosticFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_diagnostic_free(ptr >>> 0, 1),
      );
...
const DocumentHighlightFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_documenthighlight_free(ptr >>> 0, 1),
      );
...
const FileHandleFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_filehandle_free(ptr >>> 0, 1),
      );
...
const InlayHintFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_inlayhint_free(ptr >>> 0, 1),
      );
...
const LocationLinkFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_locationlink_free(ptr >>> 0, 1),
      );
...
export class LocationLink {
  ...
  get origin_selection_range() {
    const ret = wasm.__wbg_get_locationlink_origin_selection_range(
      this.__wbg_ptr,
    );
    return ret === 0 ? undefined : Range.__wrap(ret);
  }
...
const ParameterInformationFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_parameterinformation_free(ptr >>> 0, 1),
      );
...
export class ParameterInformation {
   ...
   */
  get documentation() {
    const ret = wasm.__wbg_get_parameterinformation_documentation(
      this.__wbg_ptr,
    );
    let v1;
    if (ret[0] !== 0) {
...
const SemanticTokenFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_semantictoken_free(ptr >>> 0, 1),
      );
...
const SignatureHelpFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_signaturehelp_free(ptr >>> 0, 1),
      );
...
export class SignatureHelp {
  ...
  set active_signature(arg0) {
    wasm.__wbg_set_signaturehelp_active_signature(
      this.__wbg_ptr,
...
const SignatureInformationFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_signatureinformation_free(ptr >>> 0, 1),
      );
...
export class SignatureInformation {
   ...
   */
  get documentation() {
    const ret = wasm.__wbg_get_signatureinformation_documentation(
      this.__wbg_ptr,
    );
    let v1;
    if (ret[0] !== 0) {
  ...
  set documentation(arg0) {
    ...
    var len0 = WASM_VECTOR_LEN;
    wasm.__wbg_set_signatureinformation_documentation(
      this.__wbg_ptr,
      ptr0,
      len0,
    );
...
const TextRangeFinalization =
  typeof FinalizationRegistry === "undefined"
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry((ptr) =>
        wasm.__wbg_textrange_free(ptr >>> 0, 1),
      );
...
export class Workspace {
  ...
  updateFile(file_id, contents) {
    ...
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.workspace_updateFile(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
      ptr0,
      len0,
  ...
  gotoTypeDefinition(file_id, position) {
    ...
    const ret = wasm.workspace_gotoTypeDefinition(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
      ptr0,
    );
  ...
  gotoDeclaration(file_id, position) {
    ...
    _assertClass(position, Position);
    var ptr0 = position.__destroy_into_raw();
    const ret = wasm.workspace_gotoDeclaration(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
      ptr0,
    );
  ...
  gotoDefinition(file_id, position) {
    ...
    _assertClass(position, Position);
    var ptr0 = position.__destroy_into_raw();
    const ret = wasm.workspace_gotoDefinition(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
      ptr0,
    );
  ...
  gotoReferences(file_id, position) {
    ...
    _assertClass(position, Position);
    var ptr0 = position.__destroy_into_raw();
    const ret = wasm.workspace_gotoReferences(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
      ptr0,
    );
  ...
  completions(file_id, position) {
    ...
    _assertClass(position, Position);
    var ptr0 = position.__destroy_into_raw();
    const ret = wasm.workspace_completions(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
      ptr0,
    );
  ...
  inlayHints(file_id, range) {
    ...
    const ret = wasm.workspace_inlayHints(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
      ptr0,
    );
  ...
  semanticTokens(file_id) {
    _assertClass(file_id, FileHandle);
    const ret = wasm.workspace_semanticTokens(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
    );
    if (ret[3]) {
  ...
  semanticTokensInRange(file_id, range) {
    ...
    _assertClass(range, Range);
    var ptr0 = range.__destroy_into_raw();
    const ret = wasm.workspace_semanticTokensInRange(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
      ptr0,
    );
  ...
  signatureHelp(file_id, position) {
    ...
    _assertClass(position, Position);
    var ptr0 = position.__destroy_into_raw();
    const ret = wasm.workspace_signatureHelp(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
      ptr0,
    );
  ...
  documentHighlights(file_id, position) {
    ...
    _assertClass(position, Position);
    var ptr0 = position.__destroy_into_raw();
    const ret = wasm.workspace_documentHighlights(
      this.__wbg_ptr,
      file_id.__wbg_ptr,
      ptr0,
    );
